...
cd /d "%~dp0"
title IWP Community Connections V21 Tests
...
cls
echo ============================================================
echo IWP COMMUNITY CONNECTIONS V21.2 AUTOMATED TESTS
echo ============================================================
echo.
...
copy /y "%SOURCE%setup-organizer-profile.js" "%WORK%\setup-organizer-profile.js" >nul
