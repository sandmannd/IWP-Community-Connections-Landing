(function(){
  ...
  function eventUrl(id){return '/adventure.html?id='+encodeURIComponent(id||'');} function editEventUrl(id){return '/organizer-builder.html?id='+encodeURIComponent(id||'');}
